...
Response.AddHeader "content-disposition", " filename=farmonth_parts" & year(date()) & month(date()) & day(date()) & ".xls"
%>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td colspan="2" valign="top" bgcolor="#FFFFFF"><table border="1" cellpadding="4" cellspacing="0">
              <tr>
                <td colspan="36" align="left" class="style1"><strong>Failure Analysis Rate (FAR) by Spare Parts</strong></td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td colspan="2" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><%=convertmonth(jobmonth)%></strong></font></td>
                <td colspan="2" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><%=convertmonth(month(DateAdd("m",-1,currentdate)))%></strong></font></td>
                <td colspan="2" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><%=convertmonth(month(DateAdd("m",-2,currentdate)))%></strong></font></td>
                <td colspan="2" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><%=convertmonth(month(DateAdd("m",-3,currentdate)))%></strong></font></td>
                <td colspan="2" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><%=convertmonth(month(DateAdd("m",-4,currentdate)))%></strong></font></td>
                <td colspan="2" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><%=convertmonth(month(DateAdd("m",-5,currentdate)))%></strong></font></td>
                <td colspan="2" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><%=convertmonth(month(DateAdd("m",-6,currentdate)))%></strong></font></td>
                <td colspan="2" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><%=convertmonth(month(DateAdd("m",-7,currentdate)))%></strong></font></td>
                <td colspan="2" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><%=convertmonth(month(DateAdd("m",-8,currentdate)))%></strong></font></td>
                <td colspan="2" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><%=convertmonth(month(DateAdd("m",-9,currentdate)))%></strong></font></td>
                <td colspan="2" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><%=convertmonth(month(DateAdd("m",-10,currentdate)))%></strong></font></td>
                <td colspan="2" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><%=convertmonth(month(DateAdd("m",-11,currentdate)))%></strong></font></td>
              ...
              <tr>
                ...
                <td align="left" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span>Part(s)</span></strong></font></td>
...
%>
              <tr>
                ...
                <td align="center" nowrap="nowrap" bgcolor="#FFFFFF"><strong><font color="#0000FF"><%=rs1("fa_month2_over")%></font></strong></td>
                <td align="center" nowrap="nowrap" bgcolor="#FFFFFF"><strong><font color="#0000FF"><%=rs1("fa_month2_under")%></font></strong></td>
                ...
                <td align="center" nowrap="nowrap" bgcolor="#F3F3F3"><strong><font color="#0000FF"><%=rs1("fa_month11_over")%></font></strong></td>
                <td align="center" nowrap="nowrap" bgcolor="#F3F3F3"><strong><font color="#0000FF"><%=rs1("fa_month11_under")%></font></strong></td>
...
fa_month4_over = fa_month4_over + rs1("fa_month4_over")
fa_month4_under = fa_month4_under + rs1("fa_month4_under")
fa_month5_over = fa_month5_over + rs1("fa_month5_over")
fa_month5_under = fa_month5_under + rs1("fa_month5_under")
fa_month6_over = fa_month6_over + rs1("fa_month6_over")
fa_month6_under = fa_month6_under + rs1("fa_month6_under")
fa_month7_over = fa_month7_over + rs1("fa_month7_over")
fa_month7_under = fa_month7_under + rs1("fa_month7_under")
fa_month8_over = fa_month8_over + rs1("fa_month8_over")
fa_month8_under = fa_month8_under + rs1("fa_month8_under")
fa_month9_over = fa_month9_over + rs1("fa_month9_over")
fa_month9_under = fa_month9_under + rs1("fa_month9_under")
fa_month10_over = fa_month10_over + rs1("fa_month10_over")
fa_month10_under = fa_month10_under + rs1("fa_month10_under")
fa_month11_over = fa_month11_over + rs1("fa_month11_over")
fa_month11_under = fa_month11_under + rs1("fa_month11_under")
fa_month12_over = fa_month12_over + rs1("fa_month12_over")
fa_month12_under = fa_month12_under + rs1("fa_month12_under")
