...
sql = "SELECT do_id, do_no, do_status, do_date, do_inv_no, do_inv_date, do_cust_code, do_cust_name, do_cust_address, do_cust_postcode, do_cust_state, " & _
		"do_cust_state_id, do_cust_city, do_cust_city_id, do_cust_cnty_id,do_cust_email, do_cust_tel1, do_cust_tel2, do_remark, do_createddate, do_createdby, do_job_code,  " & _
...
sql = "select cnty_name from tblcountry where cnty_id =" & do_cust_cnty_id	
do_country_name = selectid(sql)
%>
  ...
  <tr>
    <td width="300" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#E5E5E5" id="ctl00_ContentPlaceHolder1_GV2">
      <tbody>
        ...
        <tr>
          <td align="left" valign="top" bgcolor="#FFFFFF"><font color="#000000"><strong>Country*</strong></font></td>
          <td align="left" bgcolor="#FFFFFF"><%=do_country_name%></td>
        </tr>
        <tr>
