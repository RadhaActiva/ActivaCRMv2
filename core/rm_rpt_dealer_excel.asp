...
Response.AddHeader "content-disposition", " filename=Dealer_Commission" & searchvalue & year(date()) & month(date()) & day(date()) & ".xls"
...
%>
<!-- #include file="database/datastore.asp" -->
<h4>Installation Job Submission Form (Commission Report)</h4>
<table>
   ...
   <tr>
                  <table border="0" cellpadding="4" cellspacing="0" bordercolor="#E8E8E8">
                      ...
                      <td width="109" height="30" align="left" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span>Warranty <br />Info</span></strong></font></td>
                        ...
                        <td width="109" height="30" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span>Commission<br />(MYR)</span></strong></font></td>
...
%>             
                      ...
                      <td height="40" align="center"><%=i%></td>
                        ...
                        If Not IsNull(rs1("job_type")) Then
                            If rs1("job_type") = "CF" Then
                                comm_paid = 10
                            ElseIf rs1("job_type") = "WH" Then
                                comm_paid = 20
                            End If
                        End If
                        %>
                       <td class="num2" align="right" nowrap="nowrap" >
                            <%= CDbl(Replace(comm_paid & "", ",", "")) %>
                        </td>
                        <td class="num2" align="right" nowrap="nowrap">
    ...
    <tr></tr>
      <tr bgcolor="#F3F3F3">
                  ...
                  <td class="num2" align="right" nowrap="nowrap" bgcolor="#999999">
                    <strong><%= CDbl(Replace(t_totalcomm & "", ",", "")) %></strong>
                   </td>
