...
sql2 = "SELECT sum(tblinvoice.inv_totalqty) as totalqty, sum(tblinvoice.inv_totalPartsAmt*0.9433962264) totalPartsAmt, sum(tblinvoice.inv_labourAmt*0.9433962264) as totallabourAmt,  " & _
		...
		"sum(tblinvoice.inv_payment) as totalpayment, sum(tblinvoice.inv_cnamount) as totalcnamount, sum(tblinvoice.inv_balance) as totalbalance " & _
...
sql2 = "SELECT tblinvoice.inv_id, tblinvoice.inv_no, tblinvoice.inv_date, tblinvoice.inv_cust_code, tblinvoice.inv_cust_name, tblinvoice.inv_cust_address,  " & _
		...
		"tblinvoice.inv_payment, tblinvoice.inv_cnamount, tblinvoice.inv_balance, tblinvoice.inv_payment_type, tblinvoice.inv_chequeno, tblinvoice.inv_payment_remark,  " & _
...
%>  
          ...
          <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td class="titleblue1"><div align="left"><font color="#CC0000">Report </font>Sales Invoice Summary (Cross Month)</div></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="20%" align="center" class="titlegrey1"><a href="rm_rpt_salesanalysis_summary_excel.asp" target="_blank"><img src="images/excel.jpg" width="57" height="21" border="0" /></a></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><form id="form1" name="form1" method="post" action="rm_rpt_salesanalysis_summary.asp?type=searchdata">
	...
	For j = 1 To pgCount
				...
				Else
					Response.Write " <a href='rm_rpt_salesanalysis_summary.asp?num=" & (j-1) * row & link & "'>"& j &"</a>"
				End If
	...
	If Remain > row Then
	  Response.Write "<a href='rm_rpt_salesanalysis_summary.asp?num=" & Showed+row & link & "'> Next >></a>"
	End If
...
%>
                   <tr bgcolor="<%=nbgcolor%>">
                      ...
                      <td align="left"><%=rs("inv_cust_code") & " " & left(rs("inv_cust_name"),15) %></td>
                      <td align="left"><%=rs("inv_tech_code") &  "<br>" & left(rs("tech_name"),15)%></td>
...
inv_totalPartsAmt = inv_totalPartsAmt + ccur(rs("inv_totalPartsAmt"))
inv_labourAmt = inv_labourAmt + ccur(rs("inv_labourAmt"))
inv_transportAmt = inv_transportAmt + ccur(rs("inv_transportAmt"))
...
%>
                    ...
                    <tr bgcolor="#F3F3F3">
                      ...
                      <td align="right" bgcolor="#CCCCCC"><strong><%=chknumber2(inv_totalPartsAmt)%></strong></td>
                      <td align="right" bgcolor="#CCCCCC"><strong><%=chknumber2(inv_labourAmt)%></strong></td>
                      <td align="right" bgcolor="#CCCCCC"><strong><%=chknumber2(inv_transportAmt)%></strong></td>
                      ...
                      <td align="right" bgcolor="#CCCCCC"><strong><%=chknumber2(inv_balance)%></strong></td>
                    </tr>
                     <tr bgcolor="#F3F3F3">
                      <td height="40" colspan="7" align="right" bgcolor="#999999"><strong>Grand Total</strong></td>
                      <td align="right" nowrap="nowrap" bgcolor="#999999"><strong><%=chknumber2(totaltotalAmt)%></strong></td>
                      <td align="right" bgcolor="#999999"><strong><%=chknumber2(totalgstAmt)%></strong></td>
                      <td align="right" bgcolor="#999999"><strong><%=chknumber2(totalPartsAmt)%></strong></td>
                      <td align="right" bgcolor="#999999"><strong><%=chknumber2(totallabourAmt)%></strong></td>
                      <td align="right" bgcolor="#999999"><strong><%=chknumber2(totaltransportAmt)%></strong></td>
                      <td align="right" bgcolor="#999999"><strong><%=chknumber2(totalpayment)%></strong></td>
                      <td align="right" bgcolor="#999999"><strong><%=chknumber2(totalcnamount)%></strong></td>
                      <td align="right" bgcolor="#999999"><strong><%=chknumber2(totalbalance)%></strong></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
