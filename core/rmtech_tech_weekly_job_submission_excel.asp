...
<h2>Weekly Service Job Submission Form (Posted Jobs)</h2>
...
%>
  <tr bgcolor="<%=nbgcolor%>">
    ...
    <td align="left" nowrap="nowrap" bgcolor="#FFFFFF"><%=chkdate(rs1("job_date"))%></td>
...
if rs1("job_tech_model") <> "TAE07-800" and rs1("job_tech_model") <> "TAE07-810" and rs1("job_tech_model") <> "TAE07-811" and rs1("job_tech_model") <> "TAE07-812" then
        ...
        if rs1("job_actual_wrty_status") = "Over" then 
         ...
         if rs1("tech_type") = "TPC" or rs1("tech_type") = "IC" or rs1("tech_type") = "IHC" then
            if rs1("job_count") > 1 and rs1("job_actual_wrty_status") = "Under" then 'logic applicable for TPC and IC and IHC
