...
if request("claim_id") <> "" and request("tech_code") <> "" then
        sql1 = "SELECT tp_id,tp_date,tp_year,tp_month,tp_vehicle_no,tp_tech_code,tp_trip_date,tp_job_sheet,tp_mileage_start,tp_mileage_end,tp_distance,tp_claim_amount " & _      
            "FROM tbltech_claim_petrol where tp_tech_code = '" & request.cookies("GAPS")("sloginid") & "' and tp_id = '" & request("claim_id") & "'"
        ...
        If Not rs.EOF Then
            ...
            claim_amount = rs("tp_claim_amount")
            rs.Close
...
sql1 = "SELECT tp_id,tp_date,tp_year,tp_month,tp_vehicle_no,tp_tech_code,tp_trip_date,tp_job_sheet,tp_mileage_start,tp_mileage_end,tp_distance,tp_claim_amount " & _      
    "FROM tbltech_claim_petrol where tp_tech_code = '" & request.cookies("GAPS")("sloginid") & "' order by tp_date desc"
rs.ActiveConnection = strconnect
rs.Source = sql1
rs.CursorLocation  = 3
rs.Open
          ...
          <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td><div align="left"><font color="#CC0000"><strong>Petrol Claim Form</strong></font></div></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td valign="top" bgcolor="#FFFFFF"><form name="form1" id="form1" method="post" action="action.asp?type=<%=stype%>" >
                       ...
                       <tr>
                        ...
                        <td><input name="tech_code" type="text" id="tech_code" style="background-color: #cccccc;" value="<%=tech_code%>" size="15" readonly/></td>
                           <td width="20%" align="left" class="titlegrey1">
                            <a href="rmtech_petrol_claims_excel.asp?jobmonth=<%=jobmonth%>&jobyear=<%=jobyear%>&tech_code=<%=tech_code%>" target="_blank">
                    ...
                    <select name="jobmonth" id="jobmonth">
                      ...
                      <tr>
                        <td width="10%" bgcolor="#CD6155"><div align="left"><font color="#FFFFFF">Vehicle Number</font></div></td>
                        <td><input name="vehicle_no" type="text" id="vehicle_no" size="15" value="<%=vehicle_no%>" /></td>
                      </tr>
                         <tr>
                       ...
                       <tr>
                        ...
                        <td><input name="claim_id" type="text" id="claim_id" size="12" maxlength="7" style="background-color: #cccccc;" value="<%=claim_id%>" readonly /></td><td width="5%"></td>
                         ...
                         <tr>
                        <td width="10%" bgcolor="#CD6155"><div align="left"><font color="#FFFFFF">Date</font></div></td>
                       ...
                       <tr>
                        ...
                        <tr>
                        <td width="16%" bgcolor="#CD6155"><div align="left"><font color="#FFFFFF">Mileage Start</font></div></td>
                        <td><input name="mileage_start" type="text" id="mileage_start" size="12" maxlength="7" value="<%=mileage_start%>" /></td><td width="5%"></td>
                      </tr>
                        <tr>
                        <td width="16%" bgcolor="#CD6155"><div align="left"><font color="#FFFFFF">Mileage End</font></div></td>
                        <td><input name="mileage_end" type="text" id="mileage_end" size="12" maxlength="7" value="<%=mileage_end%>" /></td><td width="5%"></td>
                      </tr>
                        <tr>
                        <td width="16%" bgcolor="#CD6155"><div align="left"><font color="#FFFFFF">Distance (KM)</font></div></td>
                        <td><input name="distance" type="text" id="distance" size="12" readonly style="background-color: #cccccc;" value="<%=distance%>" /></td><td width="5%"></td>
                      </tr>      
                        <tr>
                        <td width="16%" bgcolor="#CD6155"><div align="left"><font color="#FFFFFF">Claim Amount (RM)</font></div></td>
                        <td><input name="claim_amount" type="text" id="claim_amount" size="6" value="<%=ChkNumber2(claim_amount)%>" /></td><td width="5%"></td>
                      </tr>      
                         <tr>
                         <td colspan="2" valign="top" bgcolor="#FFFFFF">&nbsp;</td>
                        </tr>
                ...
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="4" cellspacing="0">
                    <tr>
                      ...
                      <td align="left" bgcolor="#475387" class="style1"><font color="#FFFFFF"><strong>Date</strong></font></td>
                      <td align="left" bgcolor="#475387" class="style1"><font color="#FFFFFF"><strong>Job Sheet</strong></font></td>
                      <td align="left" bgcolor="#475387" class="style1"><font color="#FFFFFF"><strong>Mileage Begin</strong></font></td>
                      <td align="left" bgcolor="#475387" class="style1"><font color="#FFFFFF"><strong>Mileage End</strong></font></td>
                      <td align="left" bgcolor="#475387" class="style1"><font color="#FFFFFF"><strong>Distance (KM)</strong></font></td>
                      <td align="left" bgcolor="#475387" class="style1"><font color="#FFFFFF"><strong>Claim Amount (RM)</strong></font></td>
...
%>
                    <tr bgcolor="#FFFFFF">
                      <td align="left"><%=rs("tp_id")%></td>
                      <td> <%=chkdate(rs("tp_date"))%></td>
                      <td> <%=rs("tp_month")%>/<%=rs("tp_year")%></td>
                      <td> <%=chkdate(rs("tp_trip_date"))%></td>
                      <td> <%=rs("tp_job_sheet")%> </td>
                      <td> <%=rs("tp_mileage_start")%> </td>
                      <td> <%=rs("tp_mileage_end")%> </td>
                      <td align="center"> <%=rs("tp_distance")%></td>
                      <td align="center"> <%=ChkNumber2(rs("tp_claim_amount"))%></td>
                      <td>
                          <input type="button" name="aditem211" id="aditem211" value="Edit" onclick="document.location.href='rmtech_petrol_claims.asp?claim_id=<%=rs("tp_id")%>&tech_code=<%=tech_code%>#claims'"/>
                          <input type="button" name="button9" id="button22" value="Del" onclick="javascript:confirmDel('<%=rs("tp_id")%>','action.asp?type=delPetrolClaim&claim_id=<%=rs("tp_id")%>&tech_code=<%=tech_code%>&jobmonth=<%=jobmonth%>&jobyear=<%=jobyear%>')"/>                                                                                 
                      </td>
                    </tr>
