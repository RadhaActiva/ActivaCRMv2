...
// -->
        ...
        <tr>
               ...
               <tr>
                ...
                <tr>
                  ...
                  <td width="51%" valign="top" bgcolor="#FFFFFF">
                      <table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#E5E5E5" id="ctl00_ContentPlaceHolder1_GV3">
                    <tbody>
                      <tr bgcolor="#E8E8E8">
				...
				%>
                       ...
                       <tr>
                        ...
                        <td align="left"><input name="tech_creditlimit2" type="text" id="tech_creditlimit2" value="<%=tech_creditlimit%>" size="10" maxlength="50" />%</td>
                ...
                <tr>
                  <td colspan="2" align="right" valign="top" bgcolor="#FFFFFF"><input type="submit" name="button" id="button" value="<%=actionname%>" /></td>
                </tr>
                </form>
          ...
          scope="col"><table width="100%" border="0" cellpadding="8" cellspacing="0">
                        <tr bgcolor="#CD6155">
...
%>
          ...
          scope="col"><strong>Page</strong> <font color="3366ff"> <%=pagestartno%></font>of <font color="3366ff"> <%=pgCount%></font>:
                      <%	
	i = 0
	For j = 1 To pgCount
	...
	End If
          ...
          scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="8">
                        <tr bgcolor="#CD6155">
                          <td colspan="6" align="left" bgcolor="#E8E8E8"><strong><font size="2">Spare Parts Request Records</font></strong></td>
                        </tr>
                        <tr bgcolor="#475387">
                          <td width="6%" align="center"><font color="#FFFFFF"><strong>No</strong></font></td>
                          <td width="23%" align="left"><font color="#FFFFFF"><strong>Request No</strong></font></td>
                          <td width="22%" align="left"><font color="#FFFFFF"><strong>Request Date</strong></font></td>
                          <td width="21%" align="center"><font color="#FFFFFF"><strong>Status</strong></font></td>
                          <td width="14%" align="center"><font color="#FFFFFF"><strong>Request Qty</strong></font></td>
                          <td width="14%" align="right"><font color="#FFFFFF"><strong>Total Amt (RCP)</strong></font></td>
                        </tr>
<%				
i = 1
sql1 = "SELECT sp_id, sp_no, sp_tech_code, sp_tech_name, sp_tech_address, sp_tech_postcode, sp_tech_state, sp_tech_city, sp_tech_email, sp_tech_tel1, " & _
...
"FROM tblsparepartrequest WHERE sp_tech_code = '" & tech_code & "'"
...
count = Showed + 1
    ...
    if not rs1.eof then
        ...
        %>
                      ...
                      <tr>
                                 <td align="center"><%=j%>.</td>
                                 <td align="left"><strong><a href="rm_consignment_new.asp?sp_no=<%=rs1("sp_no")%>" target="_blank"><%=rs1("sp_no")%></a></strong></td>
                                  <td align="left"><strong><%=rs1("sp_no")%></strong></td>
                                  <td align="left"><strong><%=chkdate(rs1("sp_date"))%></strong></td>
                                  <td align="center"><strong><%=rs1("sp_status")%></strong></td>
                                  <td align="center"><strong><%=rs1("sp_totalqty")%></strong></td>
                                  <td align="right"><strong><%=chknumber2(rs1("sp_totalAmt"))%></strong></td>
                                </tr>                       
        <%	
        sp_totalqty = sp_totalqty + rs1("sp_totalqty")
        sp_totalAmt = sp_totalAmt + rs1("sp_totalAmt")
        count = count + 1 
        i = i + 1
        rs1.MoveNext
        Next
...
%>                  
                          <tr>
                            <td colspan="3" align="right" bgcolor="#CCCCCC"><strong>Total</strong></td>
                            <td align="center" bgcolor="#CCCCCC"><strong></strong></td>
                            <td align="center" bgcolor="#CCCCCC"><strong><%=sp_totalqty%></strong></td>
                            <td align="right" bgcolor="#CCCCCC"><strong><%=chknumber2(sp_totalAmt)%></strong></td>
                          </tr>
                           <tr>
                            <td colspan="6" align="right"><strong>Page</strong> <font color="3366ff"> <%=pagestartno%></font>of <font color="3366ff"> <%=pgCount%></font>:
                             <%	
	i = 0
	For j = 1 To pgCount
				If CInt(Showed) = ((j-1) * row) Then
					Response.Write "<font color=#000000><b>"& j &"</b></font>"
				Else
					Response.Write " <a href='rm_jobsheet_view.asp?num=" & (j-1) * row & link & "'>"& j &"</a>"
				End If
			If Not j = pgCount Then Response.Write " "
	i = i + 1
	Next
	...
	If Remain > row Then
	  Response.Write "<a href='rm_jobsheet_view.asp?num=" & Showed+row & link & "'> Next >></a>"
	End If
