              ...
              <tr>
                <td width="45%" valign="top" bgcolor="#FFFFFF"><table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#E5E5E5" id="ctl00_ContentPlaceHolder1_GV2">
                    <tbody>
                      ...
                      <tr>
                        <td align="left" valign="top" bgcolor="#CD6155"><font color="#FFFFFF"><strong>JS Received Acknowlege</strong></font></td>
                ...
                <td width="55%" valign="top" bgcolor="#FFFFFF"><table width="99%" border="1" align="right" cellpadding="3" cellspacing="0" bordercolor="#E5E5E5" id="ctl00_ContentPlaceHolder1_GV3">
                    <tbody>
                      ...
                      <tr>
                        ...
                        <td colspan="3" align="left"><%=job_Model%>
                        </td>
                      </tr>
                      <tr>
                        <td bgcolor="#CD6155"><font color="#FFFFFF"><strong>Model Description</strong></font></td>
...
Remark*<br />
                              ...
                              <td align="left"><strong><%=job_tech_faulty_action%>
                              </strong></td>
                              <td align="left" bgcolor="#CD6155"><font color="#FFFFFF"><strong>Warranty Photo<br />
(Optional) </strong></font></td>
                              <td align="left">
                              <a href="shared/<%=job_wrty_photo%>" target="_blank"><img src="shared/<%=job_wrty_photo%>" alt="Click on to Pop-up" width="100" border="0" /></a></td>
                            </tr>
                          </tbody>
                      </table></td>
                    </tr>
...
<tr>
          ...
          scope="col"><table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#E5E5E5" id="ctl00_ContentPlaceHolder1_GV8">
                        <tbody>                          <tr bgcolor="#E8E8E8">
                            <td colspan="4" bgcolor="#E8E8E8" scope="col"><strong>HQ Update</strong></td>
                          </tr>
                          <tr >
                            <td width="12%" rowspan="2" nowrap="nowrap" bgcolor="#CD6155"><font color="#FFFFFF"><strong>Remark<br />
                            </strong>(150 Chars) </font></td>
                            <td width="38%" rowspan="2" align="left"><strong><%=job_hq_remark%></strong></td>
                            <td width="29%" align="left" nowrap="nowrap" bgcolor="#CD6155"><font color="#FFFFFF"><strong>HQ Received Date</strong></font></td>
                            <td width="21%" align="left"><%=chkdate(job_hq_received_date)%></td>
                          </tr>
                          <tr >
                            <td align="left" bgcolor="#CD6155"><font color="#FFFFFF"><strong>Repair Date</strong></font></td>
                            <td align="left"><font color="#000000"><strong><%=chkdate(job_repair_date)%></td>
                          </tr>
                          <tr >
                            <td nowrap="nowrap" bgcolor="#CD6155">&nbsp;</td>
                            <td align="left">&nbsp;</td>
                            <td align="left" bgcolor="#CD6155"><font color="#FFFFFF"><strong>Return to Technician Date</strong></font></td>
                            <td align="left"><font color="#000000"><strong><%=chkdate(job_return_tech_date)%></strong></font></td>
                          </tr>
                          <tr >
                            <td width="12%" nowrap="nowrap" bgcolor="#CD6155"><font color="#FFFFFF"><strong>Category Code</strong></font></td>
                            <td width="38%" align="left"><%=job_hq_category_code%>
                             </td>
                            <td align="left" bgcolor="#CD6155"><font color="#FFFFFF"><strong>Return to Customer Date</strong></font></td>
          ...
          scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="8">
                        <tr bgcolor="#CD6155">
                          <td colspan="8" bgcolor="#E8E8E8"><strong><font size="2">Re-Assign History</font></strong></td>
                        </tr>
                        <tr bgcolor="#475387">
                          <td align="center"><font color="#FFFFFF"><strong>No</strong></font></td>
                          <td align="center"><font color="#FFFFFF"><strong>Re-Assign Date</strong></font></td>
                          ...
                          <td align="center"><font color="#FFFFFF"><strong>Technician Name</strong></font></td>
                          <td align="center"><font color="#FFFFFF"><strong>Re-Assigned By</strong></font></td>
                          </tr>
                          
<%				set rs1 = server.CreateObject("adodb.recordset")
				i = 1
				sql1 = "SELECT top 10 tbljob_reassign.job_id, tbljob_reassign.job_code, tbljob_reassign.job_count, tbljob_reassign.job_date, tbljob_reassign.job_cust_code, tbljob_reassign.job_cust_name, tbljob_reassign.job_cust_address, " & _
				"tbljob_reassign.job_cust_postcode, tbljob_reassign.job_cust_state, tbljob_reassign.job_cust_state_id, tbljob_reassign.job_cust_city, tbljob_reassign.job_cust_city_id, tbljob_reassign.job_cust_email,  " & _
				"tbljob_reassign.job_cust_tel1, tbljob_reassign.job_cust_tel2, tbljob_reassign.job_createddate, tbljob_reassign.job_createdby, tbljob_reassign.job_JS_receiveddate, tbljob_reassign.job_JS_receivedby,  " & _
				"tbljob_reassign.job_status, tbljob_reassign.job_purchase_date, tbljob_reassign.job_onlineWrtyNo, tbljob_reassign.job_onlineWrtyStatus, tbljob_reassign.job_type, tbljob_reassign.job_SN_no,  " & _
				"tbljob_reassign.job_Model, tbljob_reassign.job_faulty_desc, tbljob_reassign.job_reportedby, tbljob_reassign.job_appointment_date, tbljob_reassign.job_appointment_time,  " & _
				"tbljob_reassign.job_tech_code, tbljob_reassign.job_appointment_remark, tbljob_reassign.job_emailsentdate, tbljob_reassign.job_emailsent, tbljob_reassign.job_smssentdate,  " & _
				"tbljob_reassign.job_smssent, tbljob_reassign.job_tech_type, tbljob_reassign.job_tech_model, tbljob_reassign.job_tech_tax_invoice, tbljob_reassign.job_tech_SN,  " & _
				"tbljob_reassign.job_tech_faulty_reason, tbljob_reassign.job_tech_faulty_action, tbljob_reassign.job_tech_status, tbljob_reassign.job_tech_product_collectdate,  " & _
				"tbljob_reassign.job_tech_returntoCustDate, tbljob_reassign.job_actual_wrty_status, tbljob_reassign.job_wrty_photo, tbljob_reassign.job_hq_remark,  " & _
				"tbljob_reassign.job_hq_category_code, tbljob_reassign.job_hq_received_date, tbljob_reassign.job_totalPartsAmt, tbljob_reassign.job_totallabourAmt, tbljob_reassign.job_totaltransportAmt,  " & _
				"tbljob_reassign.job_totalAmt, tbljob_reassign.job_repair_date, tbljob_reassign.job_return_tech_date, tbljob_reassign.job_office_issueRemark, tbljob_reassign.job_office_supervisor,  " & _
				"tbljob_reassign.job_office_taxinvoice, tbljob_reassign.job_rcn_no, tbljob_reassign.job_rcn_Date, tbljob_reassign.job_reassignedby, tbljob_reassign.job_reassigndate, tbljob_reassign.job_inv_no, tbljob_reassign.job_do_no, tbltechnician.tech_name, tbltechnician.tech_tel1 " & _
				"FROM tbljob_reassign left outer join tbltechnician on tbljob_reassign.job_tech_code = tbltechnician.tech_code where tbljob_reassign.job_id is not null and " & _
				"tbljob_reassign.job_code = '" & job_code & "' "
...
%>   
                        <tr>
                          ...
                          <td align="center"><strong><%=chkdate(rs1("job_reassigndate"))%></strong></td>
                          <td align="center"><%=rs1("job_tech_model")%></td>
                          <td align="center"><%=chkdate(rs1("job_date"))%></td>
                          <td align="center"><%=rs1("job_status")%></td>
                          <td align="center"><%=rs1("job_tech_code")%></td>
                          <td align="center"><%=rs1("tech_name")%></td>
                          <td align="center"><%=rs1("job_reassignedby")%><br><%=chkdatetime(rs1("job_reassigndate"))%></td>
                          </tr>
...
%> 
          ...
          scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="2">
                        <tr>
                          <td><strong><font size="2">Spare-Part Charges (Updated by HQ)<a name="spareparts" id="spareparts"></a></font></strong></td>
                          </tr>
                      </table></td>
                    </tr>
                    <tr valign="top">
...
%>
                        ...
                        <tr bgcolor="#EAEAEA">
                          <td height="25" colspan="6" align="right"><strong>Total</strong><div class="total1"> </div></td>
 ...
 <%				i = 1
				...
				"tbljob.job_date = '" & job_date & "' and tbljob.job_cust_code = '" & job_cust_code & "' and tbljob.job_code <> '" & job_code & "' "
				rs1.Open sql1,strconnect,3,3,&H0001  
                while Not rs1.EOF
%>  
                        <tr>
                          <td align="center"><%=i%>.</td>
                          <td align="center"><strong><%=rs1("job_code")%></strong></td>
                          <td align="center"><%=rs1("job_tech_model")%></td>
...
<tr>
          ...
          scope="col"><table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#E5E5E5" id="ctl00_ContentPlaceHolder1_GV5">
                        <tbody>
                          <tr bgcolor="#E8E8E8">
                            <td bgcolor="#E8E8E8" scope="col"><strong><font size="2">For Office Use</font></strong></td>
                          </tr>
                          <tr >
                            <td nowrap="nowrap"><table width="100%" border="1" cellpadding="3" cellspacing="0" bordercolor="#E5E5E5" id="ctl00_ContentPlaceHolder1_GV6">
                              <tbody>
                                <tr >
                                  <td width="11%" nowrap="nowrap" bgcolor="#CD6155"><font color="#FFFFFF"><strong>Issue Remark</strong></font></td>
                                  <td align="left"><%=job_office_issueRemark%></td>
                                  <td width="20%" align="left" nowrap="nowrap" bgcolor="#CD6155"><font color="#FFFFFF"><strong>Tax Invoice</strong></font></td>
                                  <td width="30%" align="left"><%=job_office_taxinvoice%></td>
                                  </tr>
                                <tr>
                                  <td bgcolor="#CD6155"><font color="#FFFFFF"><strong>Supervisor/ Manager</strong></font></td>
                                  <td align="left"><%=job_office_supervisor%></td>
                                  <td align="left" bgcolor="#CD6155"><font color="#FFFFFF"><strong>RCN No</strong></font></td>
                                  <td align="left"><strong><%=job_rcn_no%></strong></td>
                                </tr>
                                <tr>
                                  <td bgcolor="#CD6155">&nbsp;</td>
                                  <td></td>
                                  <td align="left" bgcolor="#CD6155"><font color="#FFFFFF"><strong>RCN Date</strong></font></td>
                                  <td align="left"><font color="#000000"><strong><%=chkdate(job_rcn_Date)%></strong></font></td>
                                </tr>
                                <tr>
                                  <td bgcolor="#CD6155">&nbsp;</td>
                                  <td></td>
                                  <td align="left" bgcolor="#CD6155"><font color="#FFFFFF"><strong>Invoice</strong></font></td>
                                ...
                                <tr>
                                  ...
                                  <td align="left" bgcolor="#CD6155"><font color="#FFFFFF"><strong>Invoice Date</strong></font></td>
