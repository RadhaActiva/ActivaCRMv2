...
Subject = CompanyName & " Riegen Marketing System - Notification for DO: " & do_no & ", Customer Code: " & do_cust_code & " - " & do_cust_name  
sbody = "" & _
 "<html> " & _
 "<head> " & _
 ...
 "  <br /> " & _
 "  This is a  notice that an DO has been generated on " & chkdate(do_date) & "<br /> " & _
 "  <br /> " & _
 "  <strong>DO:   " & do_no & "</strong><br /> " & _
 "  <strong>DO Remark:   " & request("email_remark") & "</strong><br /> " & _ 
 "  <br /> " & _
...
Doc.ImportFromUrl ImportFromUrlpath & "rm_do_new_print_pdf.asp?do_no=" & do_no
Filename = Doc.Save(Server.MapPath(documentpath & do_no & ".pdf"), true )
documents = Server.MapPath(documentpath & do_no & ".pdf")
