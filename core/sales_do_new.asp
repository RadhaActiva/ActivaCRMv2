...
// -->
        ...
        <tr>
          <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td colspan="2" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td width="77%" class="titleblue1"><div align="left">DO</div></td>
                        <td width="23%" align="right" class="titleblue1"><a href="rm_do_new_print.asp?do_no=<%=do_no%>" target="_blank"><img src="images/A4_icon.png"  height="35" width="35" alt="Print | Email this page" border="0" style="border:0"/></a></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  ...
                  <td width="51%" valign="top" bgcolor="#FFFFFF"><table width="99%" border="1" align="right" cellpadding="3" cellspacing="0" bordercolor="#E5E5E5" id="ctl00_ContentPlaceHolder1_GV3">
                    <tbody>
                      ...
                      <tr >
                        <td align="left" nowrap="nowrap" bgcolor="#333333"><font color="#FFFFFF"><strong>DO  
                          No.<br />
                      ...
                      <tr >
                        <td align="left" nowrap="nowrap" bgcolor="#333333"><font color="#FFFFFF"><strong>Status</strong></font></td>
                        <td align="left"><%=do_status%></td>
                        <td align="left" bgcolor="#333333"><font color="#FFFFFF"><strong>Purchase  Date</strong></font></td>
                        <td align="left"><font color="#000000"><%=chkdate(do_purchase_date)%></font></td>
                      </tr>
                      <tr align="left" >
                        <td align="left" nowrap="nowrap" bgcolor="#333333"><font color="#FFFFFF"><strong>Job Code</strong></font></td>
                        <td align="left"><strong><%=do_job_code%></strong></td>
                        <td align="left" bgcolor="#333333"><font color="#FFFFFF"><strong>Job Date</strong></font></td>
                        <td align="left"><%=chkdate(job_date)%></td>
                      </tr>
                      <tr align="left" >
                        <td align="left" nowrap="nowrap" bgcolor="#333333"><font color="#FFFFFF"><strong>Online Wrty No.</strong></font></td>
                        <td align="left"><%=do_onlineWrtyNo%></td>
                        <td align="left" bgcolor="#333333"><font color="#FFFFFF"><strong>Wrty Status</strong></font></td>
                      ...
                      <tr>
                        ...
                        <td colspan="3" align="left"><%=do_SN_no%></td>
                      </tr>
                      <tr>
                        <td align="left" bgcolor="#333333"><font color="#FFFFFF"><strong>Type</strong></font></td>
                        <td colspan="3" align="left"><%=do_type%></td>
                      </tr>
                      <tr>
                        <td align="left" bgcolor="#333333"><font color="#FFFFFF"><strong>Model</strong></font></td>
                        <td colspan="3" align="left"><%=do_Model%></td>
                      </tr>
                      <tr >
                        <td align="left" bgcolor="#333333"><font color="#FFFFFF"><strong>Model Description</strong></font></td>
                        <td colspan="3" align="left"><%=do_Model_desc%></td>
                      </tr>
                      <tr >
                        <td align="left" bgcolor="#333333"><font color="#FFFFFF"><strong>Appointment Date</strong></font></td>
                        <td colspan="3" align="left"><%=chkdate(do_appointment_date)%></td>
                      </tr>
                      <tr >
                        <td align="left" bgcolor="#333333"><font color="#FFFFFF"><strong>Technician</strong></font></td>
                        <td colspan="3" align="left"><%=do_tech_code%>
                          </td>
                      </tr>
                      <tr >
                        <td align="left" bgcolor="#333333"><strong><font color="#FFFFFF">Invoice No.</font></strong></td>
                        <td align="left"><label for="select13"><%=do_no%></label></td>
                        <td align="left" bgcolor="#333333"><strong><font color="#FFFFFF">Invoice Date</font></strong></td>
                        <td align="left"><%=chkdate(do_inv_date)%></td>
                      </tr>
                    </tbody>
                  </table></td>
                </tr>
                <tr>
                  <td colspan="2" align="right" valign="top" bgcolor="#FFFFFF"><label for="do_no"></label></td>
              </tr>
              </form>
          ...
          scope="col"><table width="100%" border="0" cellspacing="0" cellpadding="8">
                        <tr bgcolor="#333333">
                          <td width="10%"><font color="#FFFFFF"><strong>No</strong></font></td>
                          <td width="17%" align="left"><font color="#FFFFFF"><strong>Spare Part 
                            Code</strong></font></td>
                          <td width="34%" align="left"><font color="#FFFFFF"><strong> Description</strong></font></td>
                          <td width="22%" align="right"><font color="#FFFFFF"><strong>Unit Price (RM)</strong></font></td>
                          <td width="17%" align="right"><font color="#FFFFFF"><strong>Qty</strong></font></td>
                          </tr>
