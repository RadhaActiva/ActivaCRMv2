<!-- #include file="core/database/connect.asp" -->
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    <td align="center"><table width="764" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td><img src="images/Login-page-header.jpg" width="764" height="117" /></td>
      </tr>
      <tr>
            ...
            <td align="left" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="450" align="left" valign="top"><form name="form2" id="form2" method="post" action="validateuser.asp?type=forgetpassword"><div id="apDiv1"><span class="txt01">Lost Your Password?</span><br />
                  <br />
                  Enter your e-mail address associated with your account to reset your password.<br />
                  <br />
                            Enter your Username (e-mail address):<br />
  ...
  <input type="submit" name="button" id="button" value="Email My Password Now" />
  <br />
  <br />
  <a href="login.asp">Back to login page</a><br />
  <br />
<br />
  If you've forgotten your username and password, you must first <a href="mailto:cwchu@riegen.com.my">contact your admin</a> . 
