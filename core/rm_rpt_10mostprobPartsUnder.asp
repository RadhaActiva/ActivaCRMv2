          ...
          <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td class="titleblue1"><div align="left"><font color="#CC0000">Report </font>10 Most Problem Under warranty (By Parts)</div></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="20%" align="center" class="titlegrey1"><a href="rm_rpt_10mostprobPartsUnder_excel.asp?job_date_from=<%=job_date_from%>&amp;job_date_to=<%=job_date_to%>" target="_blank"><img src="images/excel.jpg" width="57" height="21" border="0" /></a></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><form id="form1" name="form1" method="post" action="rm_rpt_10mostprobPartsUnder.asp?type=searchdata">
...
sql2 = "SELECT tbljob_parts.jobp_partcode, tbljob_parts.jobp_desc, tbljob.job_tech_type, sum(tbljob_parts.jobp_qty) as totalParts " & _
	...
	if job_actual_wrty_status <> "" then 
	   sql2 = sql2 & " and tbljob.job_actual_wrty_status = '" & job_actual_wrty_status & "' "
	end if
	...
	if job_tech_model <> "" then 
	   sql2 = sql2 & " and tbljob_parts.jobp_partcode in ( '" & job_tech_model & "') "
	end if
	
	   sql2 = sql2 & "group by tbljob_parts.jobp_partcode, tbljob_parts.jobp_desc, tbljob.job_tech_type "
	   
	   if orderby <> "" then
	      sql2 = sql2 & " order by " & orderby & " " & ordertype
	   else
          sql2 = sql2 & " order by totalParts desc "
	   end if
...
%>
                   <tr bgcolor="<%=nbgcolor%>">
                      ...
                      <td align="left" nowrap="nowrap"><strong> <font color="#0000FF"><%=rs1("jobp_partcode")%></font></strong></td>
                      <td align="left" nowrap="nowrap"><%=rs1("jobp_desc")%></td>
                      <td align="center" nowrap="nowrap"><%=rs1("job_tech_type")%></td>
                      <td align="center" nowrap="nowrap"><strong> 
					  <a href="javascript:popup('rm_rpt_10mostprobPartsUnder_detail.asp?job_date_from=<%=job_date_from%>&job_date_to=<%=job_date_to%>&jobp_partcode=<%=rs1("jobp_partcode")%>&job_tech_type=<%=job_tech_type%>&stype=Under','cb18','scrollbars=yes,resizable=yes,width=600,height=500')">
					  <%=rs1("totalParts")%></a></strong></td>
                      <td align="center"><strong>0</strong></td>
                    </tr>
<%
totaljob = totaljob + cint(rs1("totalParts"))
i = i + 1
rs1.movenext
wend
rs1.close
