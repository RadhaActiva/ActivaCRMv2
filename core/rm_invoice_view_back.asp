...
'if searchitem = "tblreceipt.receipt_no" and searchvalue = "" then
 '    sql = sql & " and  tblreceipt.receipt_no is null and tblinvoice.inv_balance > 0"
'end if
...
if searchitem2 = "ExRecep" and inv_status = "Posted" then 'this option is to exclude already receipted and FOC items for easier ticking
...
count = count + Showed
link = "&searchitem=" & request("searchitem") & "&searchvalue=" & request("searchvalue") & "&inv_createddate_from=" & inv_createddate_from & "&inv_createddate_to=" & inv_createddate_to & "&ordertype=" & ordertype & "&orderby=" & orderby   
                ...
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="4" cellspacing="0">
                    <tr>
                      ...
                      <td align="center" bgcolor="#475387" class="style1" width="3%"><font color="#FFFFFF"><strong>Issue. Receipt </strong></font></td>
                    </tr>
<% 
job_totalAmt = 0
if not rs.eof then
...
%>
                    ...
                    <tr>
                      ...
                      <%end if%> </strong>
                        ...
                        <%if inv_status="Posted" then %>
                          <% if searchitem = "tblinvoice.inv_tech_code" then '060724 -  use only code as name may not be unique%> 
                                <% if searchvalue <> "" then %>
