...
if Searchor_date = "Y" then
   sql = sql & " and  tbldo.do_date >= '" & do_createddate_from & "' and tbldo.do_date <= '" & do_createddate_to & "' "
end if
...
%> 
        <tr>
          <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><form name="form1" id="form1" method="post" action="sales_do_view.asp?type=reset">
	...
	For j = 1 To pgCount
				...
				Else
					Response.Write " <a href='sales_do_view.asp?num=" & (j-1) * row & link & "'>"& j &"</a>"
				End If
	...
	If Remain > row Then
	  Response.Write "<a href='sales_do_view.asp?num=" & Showed+row & link & "'> Next >></a>"
	End If
                ...
                <tr>
                  <td align="right" valign="top" bgcolor="#FFFFFF"><table border="0" align="right" cellpadding="5" cellspacing="1">
                    <tr>
                      ...
                      <td <%if do_status="Open" then response.write "bgcolor='#475387'" else response.write "bgcolor='#461C13'" end if%>><strong><a href="sales_do_view.asp?do_status=Open"><font color="#FFFFFF">Open</font></a></strong></td>
                      <td <%if do_status="Delivered" then response.write "bgcolor='#475387'" else response.write "bgcolor='#461C13'" end if%>><strong><a href="sales_do_view.asp?do_status=Delivered"><font color="#FFFFFF">Delivered</font></a></strong></td>
                      <td <%if do_status="Done" then response.write "bgcolor='#475387'" else response.write "bgcolor='#461C13'" end if%>><strong><a href="sales_do_view.asp?do_status=Done"><font color="#FFFFFF">Done</font></a></strong></td>
                      <td <%if do_status="Posted" then response.write "bgcolor='#475387'" else response.write "bgcolor='#461C13'" end if%>><strong><a href="sales_do_view.asp?do_status=Posted"><font color="#FFFFFF">Posted</font></a></strong></td>
                      <td <%if do_status="Cancel" then response.write "bgcolor='#475387'" else response.write "bgcolor='#461C13'" end if%>><strong><a href="sales_do_view.asp?do_status=Cancel"><font color="#FFFFFF">Cancel</font></a></strong></td>
                    </tr>
                  </table>
                    <div align="right"></div>
...
%>
                     <tr bgcolor="<%=nbgcolor%>">
                      <td height="40"> <%=j%> </td>
                      <td nowrap="nowrap"><strong><font color="#0000FF"><a href="sales_do_new.asp?do_no=<%=rs("do_no")%>"><%=rs("do_no")%></a></font></strong></td>
                      <td nowrap="nowrap"> <%=rs("do_no")%></td>
                      <td nowrap="nowrap"> <%=chkdate(rs("do_date"))%></td>
                      <td nowrap="nowrap"> <%=rs("do_cust_name")%></td>
...
%>  
                    ...
                    <tr>
                      ...
                      <td align="center"><strong> <%=do_totalqty%> </strong></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
