          ...
          <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td class="titleblue1"><div align="left"><font color="#CC0000">Report </font>10 Most Problem Over warranty</div></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><table width="97%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      <td width="80%" class="titlegrey1">&nbsp;</td>
                      <td width="20%" align="center" class="titlegrey1"><a href="rm_rpt_10mostprobOver_excel.asp?job_date_from=<%=job_date_from%>&amp;job_date_to=<%=job_date_to%>" target="_blank"><img src="images/excel.jpg" width="57" height="21" border="0" /></a></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><form id="form1" name="form1" method="post" action="rm_rpt_10mostprobOver.asp?type=searchdata">
             ...
             calendar = window.open('date.asp',null,'WIDTH=185,HEIGHT=203,status=no,toolbar=no,menubar=no,location=no,scrollbars=no,resizable=1,top=0,right=0')"> <img src="images/calender.gif" width="20" height="19" border="0" align="absmiddle" /></a></strong></font></strong> Date must be (dd-MMM-yyyy) eg: 21-May-2015 </td>
                      ...
                      <tr>
                        <td align="left" valign="top"><span class="titlegrey1">Order by </span></td>
                        <td valign="top"><select name="orderby" id="orderby">
                          <option value="tbljob.job_Model" <% if orderby = "tbljob.job_Model" then response.write " selected" %>>Item Code</option>
                          <option value="tbljob.job_tech_type" <% if orderby = "tbljob.job_tech_type" then response.write " selected" %>>Item Type</option>
                          <option value="totaljob" <%if orderby="totaljob" then response.write " selected"%>>Cases of Fault</option>
                        </select></td>
                          <td>
