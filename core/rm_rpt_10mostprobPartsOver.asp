          ...
          <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td class="titleblue1"><div align="left"><font color="#CC0000">Report </font>10 Most Problem Over warranty (By Parts)</div></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="0" cellspacing="0">
                    <tr>
                      ...
                      <td width="20%" align="center" class="titlegrey1"><a href="rm_rpt_10mostprobPartsOver_excel.asp?job_date_from=<%=job_date_from%>&amp;job_date_to=<%=job_date_to%>" target="_blank"><img src="images/excel.jpg" width="57" height="21" border="0" /></a></td>
                    </tr>
                  </table></td>
                </tr>
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><form id="form1" name="form1" method="post" action="rm_rpt_10mostprobPartsOver.asp?type=searchdata">
...
%>
                   <tr bgcolor="<%=nbgcolor%>">
					  ...
					  <a href="javascript:popup('rm_rpt_10mostprobPartsOver_detail.asp?job_date_from=<%=job_date_from%>&job_date_to=<%=job_date_to%>&jobp_partcode=<%=rs1("jobp_partcode")%>&job_tech_type=<%=job_tech_type%>&stype=Over','cb18','scrollbars=yes,resizable=yes,width=600,height=500')">
