...
<table width="650" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td colspan="2" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      ...
      <tr>
        <td class="titleblue1"><div align="left"><strong>TAX INVOICE</strong></div></td>
        </tr>
    </table></td>
  </tr>
  <tr>
  ...
  <tr>
    <td width="300" rowspan="2" valign="top" bgcolor="#FFFFFF"><table width="300" border="1" cellpadding="3" cellspacing="0" bordercolor="#E5E5E5" id="ctl00_ContentPlaceHolder1_GV2">
      <tbody>
        ...
        <tr>
          <td width="26%" align="left" bgcolor="#333333"><font color="#FFFFFF"><strong>Cust Code *</strong></font></td>
    ...
    <td width="350" valign="top" bgcolor="#FFFFFF"><table width="350" border="1" align="right" cellpadding="3" cellspacing="0" bordercolor="#E5E5E5" id="ctl00_ContentPlaceHolder1_GV3">
      <tbody>
        ...
        <tr >
          <td width="21%" nowrap="nowrap" bgcolor="#333333"><font color="#FFFFFF"><strong>Invoice  
            No.</strong></font></td>
        ...
        <tr >
          <td nowrap="nowrap" bgcolor="#333333"><font color="#FFFFFF"><strong>Remark</strong></font></td>
  ...
  <tr>
    <td valign="top" bgcolor="#FFFFFF"><table width="350" border="1" align="right" cellpadding="3" cellspacing="0" bordercolor="#E5E5E5" id="ctl00_ContentPlaceHolder1_GV4">
      <tbody>
        ...
        <tr >
          <td width="21%" nowrap="nowrap" bgcolor="#333333"><font color="#FFFFFF"><strong>Job  
            No.</strong></font></td>
          <td width="26%" align="left"><%=job_code%></td>
          <td width="15%" align="left" nowrap="nowrap" bgcolor="#333333"><font color="#FFFFFF"><strong>Job  
            Date*</strong></font></td>
...
%>
          <tr>
            ...
            <td align="right" nowrap="nowrap">- <%=chknumber2(rs1("invd_unitcost")-rs1("invd_netcost"))%><%=rs1("invd_discounttype")%></td>
...
%>
          <tr bgcolor="#EAEAEA">
            <td height="25" colspan="3" align="left">**GST 6% Inclusive, 
              GST Amount: (SR) RM <%=chknumber2(inv_gstAmt)%></td>
