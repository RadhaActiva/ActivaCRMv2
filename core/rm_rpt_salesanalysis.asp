...
%>  
          ...
          <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td class="titleblue1"><div align="left"><font color="#CC0000">Report </font>Sales Analysis Report (Invoice)</div></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><form id="form1" name="form1" method="post" action="rm_rpt_salesanalysis.asp?type=searchdata">
	...
	For j = 1 To pgCount
				...
				Else
					Response.Write " <a href='rm_rpt_salesanalysis.asp?num=" & (j-1) * row & link & "'>"& j &"</a>"
				End If
	...
	If Remain > row Then
	  Response.Write "<a href='rm_rpt_salesanalysis.asp?num=" & Showed+row & link & "'> Next >></a>"
	End If
