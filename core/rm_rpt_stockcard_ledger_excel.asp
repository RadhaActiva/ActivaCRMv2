...
<table>
<tr><td><Strong>Item Code: </Strong></td><td nowrap="nowrap"><Strong><%=searchvalue%> - <%=prod_desc%></Strong></td></tr>
                  ...
                  <table border="0" cellpadding="4" cellspacing="0" bordercolor="#E8E8E8">
                    <tr valign="top" bgcolor="#88c0a7">
                     <td width="40" height="30" align="left" bgcolor="#666666" class="style1"><strong><font color="#FFFFFF">No</font></strong></td>
                      <td width="40" height="30" align="left" bgcolor="#666666" class="style1"><strong><font color="#FFFFFF">Date</strong></td>
...
%>
                    ...
                    total_balance = rs4("stk_balance")
                     ...
                     <tr bgcolor="<%=nbgcolor%>">
                      <td align="left" nowrap="nowrap" bgcolor="#F3F3F3"><%=i%></td>
