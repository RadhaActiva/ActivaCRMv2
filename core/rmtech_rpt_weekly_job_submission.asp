...
{
	document.form1.action = "rmtech_rpt_weekly_job_submission.asp";
          ...
          <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td colspan="2" align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                         <td class="titleblue1"><div align="left">Report Service Weekly Job Submission</div></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                    ...
                    <tr>
                      ...
                      <td width="20%" align="center" class="titlegrey1">
                          <% if job_tech_code <> "All" then %>
                            <a href="rmtech_rpt_weekly_job_submission_excel.asp?jobmonth=<%=jobmonth%>&jobyear=<%=jobyear%>&job_tech_code=<%=job_tech_code%>" target="_blank">
                ...
                <form id="form1" name="form1" method="post" action="rmtech_rpt_weekly_job_submission.asp">
                  <tr>                    
	...
	For j = 1 To pgCount
				...
				Else
					Response.Write " <a href='rmtech_rpt_weekly_job_submission.asp?num=" & (j-1) * row & link & "'>"& j &"</a>"
				End If
	...
	If Remain > row Then
	  Response.Write "<a href='rmtech_rpt_weekly_job_submission.asp?num=" & Showed+row & link & "'> Next >></a>"
	End If
