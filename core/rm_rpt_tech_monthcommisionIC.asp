          ...
          <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td class="titleblue1"><div align="left"><font color="#CC0000">Report </font>Technician Monthly Claim Report - IC Technician</div></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="4" cellspacing="0">
                    <tr>
                      ...
                      <td width="5" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span> Over Wrty Fees</span></strong></font></td>
...
sql2 = "SELECT rpc_id, rpc_month, rpc_year, rpc_tech_code, rpc_tech_name, rpc_serviceQty1, rpc_serviceAmt1, rpc_serviceQty2, rpc_serviceAmt2, " & _
		...
		"FROM tblrpr_techcommission where rpc_tech_type='IC' and rpc_month=" & jobmonth & " and rpc_year = " & jobyear & " order by rpc_tech_code "
'response.write sql2
'response.End()
i = 1	   
...
%>
                    <tr bgcolor="<%=nbgcolor%>">
                      ...
                      <td align="left" nowrap="nowrap"><strong> <font color="#0000FF"><a href="rm_rpt_tech_monthcommisionIC_print.asp?rpc_id=<%=rs1("rpc_id")%>&jobyear=<%=jobyear%>&jobmonth=<%=jobmonth%>&tech_code=<%=rs1("rpc_tech_code")%>" target="_blank"><%=rs1("rpc_tech_code")%></a></font></strong></td>
                      ...
                      <td align="center" nowrap="nowrap" bgcolor="#FFFFFF"><strong><%=ChkNumber2(rs1("rpc_overwarranty_fee"))%></strong></td>
