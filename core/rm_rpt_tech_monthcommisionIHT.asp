          ...
          <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                <tr> 
                  <td align="center" valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      <tr> 
                        <td class="titleblue1"><div align="left"><font color="#CC0000">Report </font>Technician Monthly Claim Report - IHT Technician</div></td>
                      </tr>
                    </table></td>
                </tr>
                <tr>
                ...
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><form id="form1" name="form1" method="post" action="action_report.asp?type=monthcommisionIHT">
                ...
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="4" cellspacing="0">
                    <tr>
                      ...
                      <td width="20%" align="left" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span>Technician</span></strong></font></td>
                      <td width="29%" align="left" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span>Technician Name</span></strong></font></td>
                      <td width="5" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span> Service 1st Unit<br />
                      </span></strong></font></td>
                      <td width="5" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span> Service 2nd Onward<br />
                      </span></strong></font></td>
                      <td width="5" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span> Tech Fees</span></strong></font></td>
                      <td width="5" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong>Car Allow.</strong></font></td>
                      <td width="6" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span>Phone Allow.</span></strong></font></td>
                      <td width="6" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span>Toll</span></strong></font></td>
                      <td width="6" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span>Parking</span></strong></font></td>
                      <td width="5" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span>Service Allow.</span></strong></font></td>
                      <td width="6" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span>Others </span></strong></font></td>
                      <td width="6" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span>O/Wrty Fee</span></strong></font></td>
                      <td width="5" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span>Deduction<br />
                        O/W
                      </span></strong></font></td>
                      <td width="5" align="center" bgcolor="#666666" class="style1"><font color="#FFFFFF"><strong><span>Deduction<br />
                        Spare Part
...
%>
                    <tr bgcolor="#FFFFFF">
                      ...
                      <td align="left" nowrap="nowrap"><strong><font color="#0000FF"><a href="rm_rpt_tech_monthcommisionIHT_print.asp?rpc_id=<%=rs1("rpc_id")%>&jobyear=<%=jobyear%>&jobmonth=<%=jobmonth%>&tech_code=<%=rs1("rpc_tech_code")%>" target="_blank"><%=rs1("rpc_tech_code")%></a></font></strong></td>
                      <td align="left" bgcolor="#FFFFFF"><%=rs1("rpc_tech_name")%></td>
                      <td align="center" nowrap="nowrap" bgcolor="#F3F3F3"><strong><%=ChkNumber2(rs1("rpc_serviceAmt1"))%></strong></td>
                      <td align="center" nowrap="nowrap"><strong><%=ChkNumber2(rs1("rpc_serviceAmt2"))%></strong></td>
                      <td align="center" nowrap="nowrap" bgcolor="#FFFFFF"><strong><%=ChkNumber2(rs1("rpc_techfees"))%></strong></td>
                      <td align="center" nowrap="nowrap" bgcolor="#F3F3F3"><strong><%=ChkNumber2(rs1("rpc_car_allow"))%></strong></td>
                      <td align="center"><strong><%=ChkNumber2(rs1("rpc_phone_allow"))%></strong></td>
                      <td align="center"><strong><%=ChkNumber2(rs1("rpc_toll"))%></strong></td>
                      <td align="center"><strong><%=ChkNumber2(rs1("rpc_parking"))%></strong></td>
                      <td align="center" bgcolor="#F3F3F3"><strong><%=ChkNumber2(rs1("rpc_service_allow"))%></strong></td>
                      <td align="center" bgcolor="#FFFFFF"><strong><%=ChkNumber2(rs1("rpc_others"))%></strong></td>
                      <td align="center" bgcolor="#FFFFFF"><strong><%=ChkNumber2(rs1("rpc_overwarranty_fee"))%></strong></td>
                      <td align="center" bgcolor="#F3F3F3"><strong><%=ChkNumber2(rs1("rpc_deduction_ow"))%></strong></td>
                      <td align="center" bgcolor="#FFFFFF"><strong><%=ChkNumber2(rs1("rpc_deduction_sparepart"))%></strong></td>
