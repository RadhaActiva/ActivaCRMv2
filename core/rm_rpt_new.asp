                      ...
                      <td align="left" valign="top" scope="row"><table width="98%" border="1" cellspacing="0" cellpadding="3">
                        ...
                        <tr>
                          <td align="left" bgcolor="#CCCCCC" colspan="3" scope="row"><strong>Technicians Claims</strong></td>
                           ...
                           <tr>
						 <td align="center" scope="row"><strong>1.</strong></td>
                          <td scope="row"><strong><a href="rm_rpt_weekly_job_submission.asp?type=reset" target="_blank">Tech - Weekly Service Job Submission</a></strong></td>
                          </tr>
                          <tr>
                          <td align="center" scope="row"><strong>2.</strong></td>
                          <td scope="row"><strong><a href="rm_Technician_Claim_Adjustment.asp?type=reset" target="_blank">Tech - Monthly Claims Adjustment</a></strong></td>
                          </tr>
                        <tr>
                          <td align="center" scope="row"><strong>3.</strong></td>
                          <td scope="row"><strong><a href="rm_rpt_IncentiveTechnician_new.asp" target="_blank">Tech - Generate Over-Warranty Incentive</a></strong></td>
                        </tr>
                        <tr>
                          <td align="center" scope="row"><strong>4.</strong></td>
                          <td scope="row"><strong><a href="rm_rpt_tech_monthcommisionIHT.asp?type=reset" target="_blank">Tech - Commision Report - IHT</a></strong></td>
                          </tr>
                        <tr>
                          <td align="center" scope="row"><strong>5.</strong></td>
                          <td scope="row"><strong><a href="rm_rpt_tech_monthcommisionTPC.asp?type=reset" target="_blank">Tech - Commision Report - TPC</a></strong></td>
                        </tr>                         
                      </table></td>

                      <td align="left" valign="top"><table width="98%" border="1" cellspacing="0" cellpadding="3">
                          <td width="11%" align="center" scope="row"><strong>1.</strong></td>
                          <td width="89%" scope="row"><a href="rm_rpt_salesanalysis_summary.asp?type=reset" target="_blank"><strong>Sales Invoice Summary (Cross Month)</strong></a></td>
                        </tr>
                        <tr>
                          <td align="center" scope="row"><strong>2.</strong></td>
                        ...
                        <tr>
                          <td align="center" scope="row"><strong>5.</strong></td>
                          <td scope="row"><strong><a href="rm_rpt_stockcard_ledger.asp?type=reset" target="_blank">Stock Ledger </a></strong></td>
                        </tr>
                        <tr>
                         ...
                         <tr>
                          ...
                          <td scope="row"><a href="rm_rpt_stock_movement.asp?type=reset" target="_blank"><strong>Stock Movement</strong></a></td>
                        </tr>
                          <tr>
                          ...
                          <td scope="row"><a href="rm_rpt_stockcard_ledger_stockrange.asp?type=reset" target="_blank"><strong>Stock Ledger based on Stock Range</strong></a></td>
                        </tr>
                            </tr>                      
