...
if request("type") = "editFaultyAction" then
   ...
   if not rs.EOF then 
	  ...
	  stype = "editFaultyAction"	
	  actionname = "Edit" 
   end if 
   rs.Close
 else
	  stype = "addFaultyAction"
	  actionname = "Add" 
 end if
%>  
          ...
          <td><table width="97%" border="0" align="center" cellpadding="0" cellspacing="0">
                ...
                <tr>
                  <td valign="top" bgcolor="#FFFFFF"><table width="98%" border="0" cellspacing="0" cellpadding="3">
                    <tr>
                      <td width="46%" align="left" bgcolor="#CCCCCC" scope="row"><strong> Master Setting &gt; Faulty Action View</strong></td>
                    ...
                    <tr>
                      <td colspan="2" align="left" valign="top" scope="row"><table width="100%" border="0" cellpadding="5" cellspacing="0">
                        <tr>
                          <td class="bodycopy"><input type="button" name="Submit3" value="Create New Faulty Action" onclick="document.location.href='mis_master_faultyaction_view.asp'" />
                        ...
                        <tr>
                          ...
                          <option value="WH" <%if ra_type="WH" then response.write " selected"%>>WH-Water Heater</option>
                                  ...
                                  <tr>
                                    <td width="29%" class="bodycopy"><strong>Category</strong></td>
                                    <td width="71%"><strong>
                                      <label for="ra_category"></label>
                                      <input name="ra_category" type="text" id="ra_category" value="<%=ra_category%>" size="30" maxlength="100" />
                                    </strong></td>
                                  </tr>
                                  <tr>
                                    <td valign="top"><strong>Repair Action</strong></td>
                                    <td><label for="ag_description"></label>
                                      <textarea name="ra_repairaction" cols="50" rows="4" id="ra_repairaction"><%=ra_repairaction%></textarea></td>
                                  </tr>
                                  <tr>
                                    <td>&nbsp;</td>
                              ...
                              <td align="center" valign="top"><table border="1" cellspacing="0" cellpadding="3">
                                <tr>
                                  ...
                                  <td class="whitecopy"><strong>Repair Action</strong></td>
                                  <td class="whitecopy"><strong>Category</strong></td>
				...
				%>
                                <tr>
                                  ...
                                  <td nowrap="nowrap" class="bodycopy"><%=rs("ra_category")%></td>
                                  <td nowrap="nowrap" class="bodycopy"><%=rs("ra_type")%></td>
                                  <td nowrap="nowrap"><input name="edit" type="button" class="button" id="edit" value="Edit" onclick="document.location.href='mis_master_faultyaction_view.asp?type=editFaultyAction&ra_id=<%=rs("ra_id")%>'" />
                                    <input name="edit2" type="button" class="button" id="edit2" value="Del" onclick="javascript:confirmDel('<%=rs.Fields("ra_id")%>','mis_user_action.asp?act=delFaultyAction&ra_id=<%=rs("ra_id")%>')" /></td>
                                </tr>
                                <%
				i = i + 1
				rs.movenext
